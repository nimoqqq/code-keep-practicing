...
public class GeometryUtil {
    ...
    public static void main(String[] args) {
        List<Point2D.Double> polygon =
                Arrays.asList(
                        new Point2D.Double(106.10615821825019, 38.44672593235557),
                        new Point2D.Double(106.10858779616154, 38.44671776653395),
                        new Point2D.Double(106.10849641971639, 38.44379874515901),
                        new Point2D.Double(106.10580732829365, 38.44383042279841),
                        new Point2D.Double(106.10614032339409, 38.44673262463101));


        Point2D.Double p = new Point2D.Double(106.11848635886382, 38.450782868982785);
        System.out.println(isPointInPoly(p,polygon));
    }
}
